...
import { LeftOutlined, ExpandOutlined, PlusOutlined, MinusOutlined, BarChartOutlined, LineChartOutlined, FontSizeOutlined } from '@ant-design/icons-vue'
...
const createComponent = (type, x = 100, y = 100) => {
  ...
  return {
    id: `comp_${Date.now()}`,
    type,
    name: type === 'text' ? '文本' : (type === 'bar-chart' ? '柱状图' : '折线图'),
    propValue: type === 'text' ? '双击编辑文本' : '',
    component_data: { x, y, w: 400, h: 300, z }
  }
}
